...
2. **ห้ามแปลชื่อบุคคลเด็ดขาด** เช่น ชื่อคน ชื่อเล่น คำนำหน้าชื่อ (เช่น นาย, นาง, โก, มา) ให้คงชื่อคนไว้ตามเดิมทุกตัวอักษร ไม่ว่าจะเป็นภาษาไทยหรือภาษาพม่า
3. **ห้ามข้าม ห้ามตัด หรือลดทอนงานข้อใดข้อหนึ่งทิ้งเด็ดขาด** (ต้องแปลให้ครบทุกข้อตามที่ให้ไป)
4. **ห้ามแก้ไขข้อความภาษาไทยต้นฉบับเด็ดขาด** ให้คงข้อความภาษาไทยเดิมไว้เป๊ะๆ
5. ห้ามสลับชื่องานกับชื่อพนักงาน
6. จัดรูปแบบการตอบกลับให้เหมือนตัวอย่างด้านล่างนี้เป๊ะๆ ห้ามใช้ Markdown code block:
